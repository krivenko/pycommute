...
operators (user-defined operator algebras are also supported). To learn more
about basic concepts and features of this library, please, refer to
...
There are a few :ref:`usage examples <examples>` and an API reference
